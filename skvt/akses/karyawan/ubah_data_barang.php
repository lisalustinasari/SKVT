...
if (isset($_GET['id'])) {
    $kd = $_GET['id'];
    $data_barang = $lib->get_by_id_barang($kd);
    if (!!!$data_barang) {
        echo "<script type='text/javascript'>alert('id barang tidak di temukan di database!');window.location.href = 'informasi_barang';</script>";
    }
}
if (isset($_POST['simpan'])) {
    ...
    $add_status = $lib->UbahDataBarang($idx, $jk, $sk, $wk, $hb, $hg, $hs, $stk, $tb, $ket);
    if ($add_status) {
        echo "<script type='text/javascript'>alert('Berhasil Mengubah Data!');window.location.href = 'informasi_barang';</script>";
    } else {
        echo "<script type='text/javascript'>alert('Gagal Mengubah Data!');window.location.href = 'ubah_data_barang?id='" . $data_barang['id_barang'] . "';</script>";
    }
}
?>
<!DOCTYPE html>
                                                ...
                                                <div class="col-md-12 col-lg-12">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" id="exampleFormControlSelect1" name="jenis" required>
                                                            <option value="Cotton Combed" <?php if ($data_barang['jenis_kain'] == 'Cotton Combed') {
                                                                                                echo 'selected';
                                                                                            } ?>>Cotton Combed</option>
                                                            <option value="Cotton Bamboo" <?php if ($data_barang['jenis_kain'] == 'Cotton Bamboo') {
                                                                                                echo 'selected';
                                                                                            } ?>>Cotton Bamboo</option>
                                                            <option value="Cotton Carded" <?php if ($data_barang['jenis_kain'] == 'Cotton Carded') {
                                                                                                echo 'selected';
                                                                                            } ?>>Cotton Carded</option>
                                                            <option value="Cotton Lactose CVC" <?php if ($data_barang['jenis_kain'] == 'Cotton Lactose CVC') {
                                                                                                    echo 'selected';
                                                                                                } ?>>Cotton Lactose CVC</option>
                                                        </select>
                                                    </div>
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" id="exampleFormControlSelect1" name="seri_kain" required>
                                                            <option value="30s" <?php if ($data_barang['seri_kain'] == '30s') {
                                                                                    echo 'selected';
                                                                                } ?>>30s</option>
                                                            <option value="20s" <?php if ($data_barang['seri_kain'] == '20s') {
                                                                                    echo 'selected';
                                                                                } ?>>20s</option>
                                                            <option value="40s" <?php if ($data_barang['seri_kain'] == '40s') {
                                                                                    echo 'selected';
                                                                                } ?>>40s</option>
                                                        </select>
                                                    </div>
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" id="exampleFormControlSelect1" name="warna_kain" required>
                                                            <option value="Merah" <?php if ($data_barang['warna_kain'] == 'Merah') {
                                                                                        echo 'selected';
                                                                                    } ?>>Merah</option>
                                                            <option value="Putih" <?php if ($data_barang['warna_kain'] == 'Putih') {
                                                                                        echo 'selected';
                                                                                    } ?>>Putih</option>
                                                            <option value="Hitam" <?php if ($data_barang['warna_kain'] == 'Hitam') {
                                                                                        echo 'selected';
                                                                                    } ?>>Hitam</option>
                                                            <option value="Hijau Botol" <?php if ($data_barang['warna_kain'] == 'Hijau Botol') {
                                                                                            echo 'selected';
                                                                                        } ?>>Hijau Botol</option>
                                                            <option value="Merah Maroon" <?php if ($data_barang['warna_kain'] == 'Merah Maroon') {
                                                                                                echo 'selected';
                                                                                            } ?>>Merah Maroon</option>
                                                            <option value="Navy" <?php if ($data_barang['warna_kain'] == 'Navy') {
                                                                                        echo 'selected';
                                                                                    } ?>>Navy</option>
                                                        </select>
                                                    </div>
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group-prepend">
                                                            ...
                                                            <input type="number" class="form-control" id="harga_beli" required name="harga_beli" value="<?= $data_barang['harga_beli']; ?>" placeholder="ex : 200000">
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group-prepend">
                                                            <span class="input-group-text" id="basic-addon1">Rp</span>
                                                            <input type="number" class="form-control" id="harga_grosir" required name="harga_grosir" value="<?= $data_barang['harga_grosir']; ?>" placeholder="ex : 200000">
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group-prepend">
                                                            <span class="input-group-text" id="basic-addon1">Rp</span>
                                                            <input type="number" class="form-control" id="harga_satuan" required name="harga_satuan" value="<?= $data_barang['harga_satuan']; ?>" placeholder="ex : 200000">
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="harga_satuan">Stok</label>
                                                        <div class="input-group-prepend">
                                                            <input type="number" class="form-control" id="stok" placeholder="Masukan Jumlah Stok" value="<?= $data_barang['stok']; ?>" required name="stok">
                                                        </div>
                                                    </div>
                                                    <div class=" form-group">
                                                        <label for="harga_satuan">Total Berat</label>
                                                        <div class="input-group-prepend">
                                                            <input type="number" class="form-control" id="total_berat" required name="total_berat" value="<?= $data_barang['total_berat']; ?>" placeholder="Masukan Total Berat">
                                                            <span class="input-group-text" id="basic-addon1">Kg</span>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="keterangan">Keterangan</label>
                                                        <textarea class="form-control" id="keterangan" name="keterangan" required aria-label="Keterangan" placeholder="Tambah Keterangan" minlength="5"><?= $data_barang['ket']; ?></textarea>
                                                    </div>
