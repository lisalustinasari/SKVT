...
$hitung = $lib->hitungPerhari2();
$hitung2 = $lib->hitungPerhari2();
$hitung3 = $lib->hitungPerhari3();
$sum = $lib->rupiah($hitung);
$sum2 = $lib->rupiah($hitung2);
$sum3 = $lib->rupiah($hitung3);
?>
<!DOCTYPE html>
<html lang="en">
                        ...
                        <div class="page-inner py-5">
                            <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
                                <div>
                                    ...
                                    <h5 class="text-white op-7 mb-2">Selamat Datang, <?= $get_profile['nama_karyawan']; ?> </h5>
                                </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-7 col-stats">
                                                <div class="numbers">
                                                    ...
                                                    <h4 class="card-title"><?php echo $sum2; ?></h4>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-7 col-stats">
                                                <div class="numbers">
                                                    ...
                                                    <h4 class="card-title"><?php echo $sum3; ?></h4>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
