                        ...
                        <li class="nav-item active">
                            ...
                            <div class="collapse show" id="base">
                                <ul class="nav nav-collapse">
                                    <li class="active">
                                        <a href="informasi_pemasukan" data-toggle="collapse" aria-expanded="false">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="table-responsive">
                                        <table id="multi-filter-select" class="display table table-striped table-hover">
                                            ...
                                            <tbody>
                                                <?php
                                                $data_pemasukan = $lib->showPemasukan();
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td><?php $money = $lib->rupiah($row['jumlah_pemasukan']);
                                                            echo $money; ?>
                                                        </td>
                                                        <td><?= $row['ket']; ?></td>
                                                        <td>
                                                            <div class=" form-button-action">
                                                                <a href="ubah_data_pemasukan?id=<?= $row['id_pemasukan']; ?>" data-toggle="tooltip" class="btn btn-link btn-primary" data-original-title="Ubah">
                                                                    <i class="fa fa-edit"></i>
                                                                </a>
                                                                <a href="informasi_pemasukan?id=<?= $row['id_pemasukan']; ?>" data-toggle="tooltip" class="btn btn-link btn-danger" data-original-title="Hapus">
                                            ...
                                            <tfoot>
                                                <tr>
                                                    <td colspan="10"><?php $hitung = $lib->hitungPerhari2();
                                                                        $sum = $lib->rupiah($hitung);
                                                                        echo "Total Biaya Pemasukan Hari Ini : <span class='text-success'><b>" . $sum . "</b></span>"; ?>
                                                    </td>
                                                </tr>
                                            </tfoot>
                                        </table>
