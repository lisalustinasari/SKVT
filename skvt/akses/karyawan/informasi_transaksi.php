                        ...
                        <li class="nav-item active">
                            ...
                            <div class="collapse show" id="forms">
                                <ul class="nav nav-collapse">
                                    ...
                                    <li class="active">
                                        <a href="informasi_transaksi" data-toggle="collapse" class="collapsed" aria-expanded="false">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <!-- <div class="mb-4">
                                        <a class="btn btn-success" href="pengeluaran">Catat Pemasukan</a>
                                    </div> -->
                                    <div class="table-responsive">
                                        <table id="multi-filter-select" class="display table table-striped table-hover">
                                            ...
                                            <tbody>
                                                <?php
                                                $data_transaksi = $lib->showTransaksi();
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td><?php $money = $lib->rupiah($row['total_harga']);
                                                            echo $money; ?>
                                                        </td>
                                                        <td><?= $row['total_harga']; ?></td>
                                                        <td>
                                                            <div class=" form-button-action">
                                                                <a href="ubah_data_transaksi?id=<?= $row['id_transaksi']; ?>" data-toggle="tooltip" class="btn btn-link btn-primary" data-original-title="Ubah">
                                                                    <i class="fa fa-edit"></i>
                                                                </a>
                                                                <a href="informasi_transaksi?id=<?= $row['id_transaksi']; ?>" data-toggle="tooltip" class="btn btn-link btn-danger" data-original-title="Hapus">
                                            ...
                                            <tfoot>
                                                <tr>
                                                    <td colspan="10"><?php $hitung = $lib->hitungPerhari3();
                                                                        $sum = $lib->rupiah($hitung);
                                                                        echo "Total Uang Pembelian Hari Ini : <span class='text-success'><b>" . $sum . "</b></span>"; ?>
                                                    </td>
                                                </tr>
                                            </tfoot>
                                        </table>
