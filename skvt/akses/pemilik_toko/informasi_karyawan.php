...
if (isset($_GET["id"])) {
    $id_akses = $_GET["id"];
    $status_hapus = $lib->deleteKaryawan($id_akses);
    if ($status_hapus) {
...
<head>
    ...
    <title>SKVT - Informasi Karyawan</title>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Data Karyawan Vano Textile</h4>
                                </div>
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table id="multi-filter-select" class="display table table-striped table-hover">
                                            ...
                                            <tbody>
                                                <?php
                                                $data_karyawan = $lib->showKaryawan();
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td><?= $row['alamat']; ?></td>
                                                        <td><?= $row['no_tlp']; ?></td>
                                                        <td><?php $money = $lib->rupiah($row['gaji']);
                                                            echo $money; ?></td>
                                                        <?php $color = $lib->colorChange($row['status_gaji']);
                                                        echo "<td class=" . $color . ">" . $row["status_gaji"] . "</td>";
                                                        ?>
                                                        <td><?= $row['email']; ?></td>
                                                        <td>
                                                            <div class=" form-button-action">
                                                                <a href="ubah_data_karyawan?id=<?= $row['id_akses_login']; ?>" data-toggle="tooltip" class="btn btn-link btn-primary" data-original-title="Ubah">
                                                                    <i class="fa fa-edit"></i>
                                                                </a>
                                                                <a href="informasi_karyawan?id=<?= $row['id_akses_login']; ?>" data-toggle="tooltip" class="btn btn-link btn-danger" data-original-title="Hapus">
                                                                    <i class="fa fa-trash"></i>
                                                                </a>
                                                                <a href="ubah_password?id=<?= $row['id_akses_login']; ?>" data-toggle="tooltip" class="btn btn-link btn-warning" data-original-title="Ubah Password">
                                                                    <i class="fa fa-key"></i>
                                                                </a>
                                                            </div>
                                                        </td>
