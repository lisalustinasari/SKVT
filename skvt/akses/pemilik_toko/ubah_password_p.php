...
if (isset($_POST['simpan'])) {
    ...
    if ($copass === $passx) {
        ...
        $add_status = $lib->ubahPasswordPemilikToko($idx_akses, $passx);
        if ($add_status) {
            echo "<script type='text/javascript'>alert('Berhasil Mengubah Password Pemilik Toko!');window.location.href = 'informasi_pemilik_toko';</script>";
        } else {
            echo "<script type='text/javascript'>alert('Gagal Mengubah Password Pemilik Toko!');window.location.href = 'ubah_password_p?id=" . $data_pemilik_toko['id_akses_login'] . "';</script>";
        }
    } else {
        $error = '
                <div class="mb-3">
                    ...
                    <div class="page-inner">
                        <div class="page-header">
                            ...
                            <ul class="breadcrumbs">
                                ...
                                <li class="nav-item">
                                    <a href="#">Ubah Password Pemilik Toko</a>
                                </li>
                            </ul>
                        </div>
                        <div class="row">
                                ...
                                <form action="" method="POST" autocomplete="off">
                                    <div class="card">
                                        <div class="card-header">
                                            <div class="card-title">Ubah Password Pemilik Toko</div>
                                        </div>
                                        <div class="card-body">
                                            <div class="row">
