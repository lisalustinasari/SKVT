...
if (isset($_POST['simpan'])) {
    ...
    if ($cekEmail > 1) {
        echo "<script type='text/javascript'>alert('Gagal Menambahkan, Email sudah digunakan!');window.location.href = 'pemilik_toko';</script>";
    } else {
        ...
        if ($copass === $passx) {
            ...
            $notlpx = $_POST['notlpx'];
            $add_status = $lib->tambahPemilik($idx, $idx_akses, $nama_pemilikx, $notlpx, $emailx, $passx);
            if ($add_status) {
                echo "<script type='text/javascript'>alert('Berhasil Menambah Pemilik Toko!');window.location.href = 'informasi_pemilik_toko';</script>";
            } else {
                echo "<script type='text/javascript'>alert('Gagal Menambah Pemilik Toko!');window.location.href = 'pemilik_toko';</script>";
            }
        } else {
            $error = '
                    <div class="mb-3">
                    <div class="alert alert-danger bg-danger text-white rounded" style="color:white" role="alert">
                    <strong>Gagal Menambahkan Data Pemilik Toko!</strong> Password dengan Confirm Password tidak sama!
                    </div>
                    </div>
                ';
        }
...
<head>
    ...
    <title>SKVT - Tambah Pemilik Toko</title>
                                ...
                                <form action="" method="POST" autocomplete="off">
                                    <div class="card">
                                        <div class="card-header">
                                            <div class="card-title">Tambah Data Pemilik Toko</div>
                                        </div>
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-md-12 col-lg-12">
                                                    <?php
                                                    $kd = $lib->showMaxPemilikToko();
                                                    $kd2 = $lib->showMaxAkses();
                                                    echo $error;
                                                    ?>
                                                    <input type="hidden" value="<?= $kd; ?>" name="id_p">
                                                    <input type="hidden" value="<?= $kd2; ?>" name="id_akses">
                                                    <div class="form-group">
                                                        <label for="nama_pemilik">Nama Pemilik Toko</label>
                                                        <input type="text" class="form-control" id="nama_pemilik" required name="namaPemilik" placeholder="Nama Pemilik Toko">
                                                    </div>
                                                    <div class="form-group">
