...
if (isset($_POST['simpan'])) {
    ...
    if ($cekEmail > 1) {
        echo "<script type='text/javascript'>alert('Gagal Menambahkan, Email sudah digunakan!');window.location.href = 'karyawan';</script>";
    } else {
        ...
        if ($copass === $passx) {
            ...
            $add_status = $lib->tambahKaryawan($idx, $idx_akses, $nama_karyawanx, $jbtn, $alamatx, $notlpx, $emailx, $passx, $gajix);
            if ($add_status) {
                echo "<script type='text/javascript'>alert('Berhasil Menambah Karyawan!');window.location.href = 'informasi_karyawan';</script>";
            } else {
                echo "<script type='text/javascript'>alert('Gagal Menambah Karyawan!');window.location.href = 'karyawan';</script>";
            }
        } else {
            $error = '
                    <div class="mb-3">
...
<head>
    ...
    <title>SKVT - Tambah Karyawan</title>
                        ...
                        <ul class="nav nav-primary">
                            ...
                            <li class="nav-item active">
                                ...
                                <div class="collapse show" id="sidebarLayouts">
                                    <ul class="nav nav-collapse">
                                        <li class="active">
                                            <a href="karyawan" data-toggle="collapse" class="collapsed" aria-expanded="false">
                    ...
                    <div class="page-inner">
                        <div class="page-header">
                            ...
                            <ul class="breadcrumbs">
                                ...
                                <li class="nav-item">
                                    <a href="informasi_karyawan">Karyawan</a>
                                </li>
                                <li class="separator">
                                    <i class="flaticon-right-arrow"></i>
                                </li>
                                <li class="nav-item">
                                    <a href="#">Tambah Karyawan Baru</a>
                                </li>
                            </ul>
                        </div>
                        <div class="row">
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-md-12 col-lg-12">
                                                    <?php
                                                    $kd = $lib->showMaxKaryawan();
                                                    $kd2 = $lib->showMaxAkses();
                                                    echo $error;
                                                    ?>
                                                    <input type="hidden" value="<?= $kd; ?>" name="id_k">
                                                    <input type="hidden" value="<?= $kd2; ?>" name="id_akses">
                                                    <div class="form-group">
                                                        <label for="nama_karyawan">Nama Karyawan</label>
                                                        <input type="text" class="form-control" id="nama_karyawan" required name="namaKaryawan" placeholder="Nama Karyawan">
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="alamat">Alamat</label>
                                                        <textarea class="form-control" name="alamatx" required aria-label="With textarea" placeholder="Alamat" minlength="10"></textarea>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="notlp">No Telephone/WA</label>
                                                        <input type="text" class="form-control" id="notlp" required name="notlpx" placeholder="Nomor Telephone" minlength="10" onkeypress="return event.charCode >= 48 && event.charCode <=57">
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="email">Email</label>
                                                        <input type="email" class="form-control text-lowercase" id="email" required name="emailx" placeholder="ex : email@gmail.com">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group-prepend">
                                                            ...
                                                            <input type="number" class="form-control" id="gaji" required name="gajiKaryawan" placeholder="ex : 200000">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
