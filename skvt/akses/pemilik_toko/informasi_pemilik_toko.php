...
<head>
    ...
    <title>SKVT - Informasi Pemilik Toko</title>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Data Pemilik Toko</h4>
                                </div>
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table id="multi-filter-select" class="display table table-striped table-hover">
                                            ...
                                            <tbody>
                                                <?php
                                                $data_pemilik_toko = $lib->showPemilikToko();
                                                foreach ($data_pemilik_toko as $row) {
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class=" form-button-action">
                                                                <a href="ubah_data_pemilik_toko?id=<?= $row['id_akses_login']; ?>" data-toggle="tooltip" class="btn btn-link btn-primary" data-original-title="Ubah">
                                                                    <i class="fa fa-edit"></i>
                                                                </a>
                                                                <a href="informasi_pemilik_toko?id=<?= $row['id_akses_login']; ?>" data-toggle="tooltip" class="btn btn-link btn-danger" data-original-title="Hapus">
                                                                    <i class="fa fa-trash"></i>
                                                                </a>
                                                                <a href="ubah_password_p?id=<?= $row['id_akses_login']; ?>" data-toggle="tooltip" class="btn btn-link btn-warning" data-original-title="Ubah Password">
                                                                    <i class="fa fa-key"></i>
                                                                </a>
                                                            </div>
                                                        </td>
