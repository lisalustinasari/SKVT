...
if (isset($_POST['simpan'])) {
    ...
    $add_status = $lib->tambahPengeluaran($idx, $idx_akses, $jenis_peng, $bya, $ket, $foto, $tmp, $status);
    if ($add_status) {
...
<head>
    ...
    <title>SKVT - Catat Pengeluaran</title>
                                                ...
                                                <div class="col-md-12 col-lg-12">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group-prepend">
                                                            ...
                                                            <input type="number" class="form-control" id="biaya" required name="biaya" placeholder="ex : 200000">
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
