...
if (isset($_GET['id'])) {
    $kd = $_GET['id'];
    $data_pemilik_toko = $lib->get_by_id_pemilik_toko($kd);
    if (!!!$data_pemilik_toko) {
        echo "<script type='text/javascript'>alert('id karyawan tidak di temukan di database!');window.location.href = 'informasi_pemilik_toko';</script>";
    }
}
...
if (isset($_POST['simpan'])) {
    ...
    if ($cekEmail < 1) {
        echo "<script type='text/javascript'>alert('Gagal Menambahkan, Email sudah digunakan!');window.location.href = 'ubah_data_pemilik_toko?id=" . $data_pemilik_toko['id_akses_login'] . "';</script>";
    } else {
        $idx_akses = $_POST['id_akses'];
        $nama_pemilikx = $_POST['namaPemilik'];
        $notlpx = $_POST['notlpx'];
        $add_status = $lib->ubahPemilikToko($idx_akses, $nama_pemilikx, $notlpx, $emailx);
        if ($add_status) {
            echo "<script type='text/javascript'>alert('Berhasil Mengubah Data Pemilik Toko!');window.location.href = 'informasi_pemilik_toko';</script>";
        } else {
            echo "<script type='text/javascript'>alert('Gagal Mengubah Data Pemilik Toko!');window.location.href = 'ubah_data_pemilik_toko?id=" . $data_pemilik_toko['id_akses_login'] . "';</script>";
        }
    }
}
?>
...
<head>
    ...
    <title>SKVT - Ubah Data Pemilik Toko</title>
                    ...
                    <div class="page-inner">
                        <div class="page-header">
                            ...
                            <ul class="breadcrumbs">
                                ...
                                <li class="nav-item">
                                    <a href="#">Pemilik Toko</a>
                                </li>
                                <li class="separator">
                                    <i class="flaticon-right-arrow"></i>
                                </li>
                                <li class="nav-item">
                                    <a href="#">Ubah Data Pemilik Toko</a>
                                </li>
                            </ul>
                        </div>
                        <div class="row">
                                ...
                                <form action="" method="POST" autocomplete="off">
                                    <div class="card">
                                        <div class="card-header">
                                            <div class="card-title">Ubah Data Pemilik Toko</div>
                                        </div>
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-md-12 col-lg-12">
                                                    ...
                                                    echo $error;
                                                    ?>
                                                    <input type="hidden" value="<?= $data_pemilik_toko['id_akses_login']; ?>" name="id_akses">
                                                    <div class="form-group">
                                                        <label for="nama_pemilik">Nama Pemilik Toko</label>
                                                        <input type="text" class="form-control" id="nama_pemilik" value="<?= $data_pemilik_toko['nama_pemilik']; ?>" required name="namaPemilik" placeholder="Nama Pemilik Toko">
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="notlp">No Telephone/WA</label>
                                                        <input type="text" class="form-control" id="notlp" value="<?= $data_pemilik_toko['no_tlp']; ?>" required name="notlpx" placeholder="Nomor Telephone" minlength="10" onkeypress="return event.charCode >= 48 && event.charCode <=57">
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="email">Email</label>
                                                        <input type="email" class="form-control text-lowercase" id="email" required value="<?= $data_pemilik_toko['email']; ?>" name="emailx" placeholder="ex : email@gmail.com">
